'use strict';
angular.module('coledger').directive('coverflow', function() {
  return {
    restrict: 'E',
    replace: true,
...
Coverflow.prototype.nextPosition = function() {
  ...
  if (position >= this.positionLimitLeft) {
    this.velocity = 0;
    return this.positionLimitLeft;
  }
  if (position <= this.positionLimitRight) {
    this.velocity = 0;
    return this.positionLimitRight;
  }
  return position;
};
