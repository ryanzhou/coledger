angular.module("coledger").factory "Resources", ["$resource", ($resource) ->
  ...
  Resources.Attachment = $resource('/api/projects/:project_id/accounts/:account_id/transactions/:transaction_id/attachments/:id')

  Resources.ResetPassword = $resource('/api/password_resets',null,
    edit: {url: '/api/password_resets/:reset_token/edit', method: 'GET'}
    update: {url: '/api/password_resets/:reset_token/edit', method: 'PATCH'}
  )
  Resources
]
